...
seq_path = "./Resistant_Mechanism_1_test.fasta"
...
per_protein = True
per_protein_path = "./Results/Cross_Validate/Resistant_Mechanism_1_test_embedding.h5" # where to store the embeddings
