...
per_residue = False 
per_residue_path = "./Results/per_residue_embeddings.h5" # where to store the embeddings
...
per_protein = True
per_protein_path = "./Results/Cross_Validate/arg_8_test_embedding.h5" # where to store the embeddings
...
def get_embeddings( model, tokenizer, seqs, per_residue, per_protein, sec_struct, 
                   max_residues=250, max_seq_len=6000, max_batch=25 ):
