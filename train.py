...
def get_model(number_of_neurons_in_each_hlayer = [2500, 1500, 700, 300, 100]):
    ...
    dimension_of_per_prot_embedding = 1024 # 4096 for prot-albert pretrained model and 1024 for prot-bert pre-trined model and prot-T5-XL
...
def train_model(input1, y):
    ...
    model.save('/home/muhitemon/DeepMRG/embeddings_generated_using_prottrans/model_with_per_prot_embed_from_protT5XL_tanh_cd_hit40_from_all_mrg.h5')
...
if __name__ == "__main__":
    ...
    embedding_filename = "/home/muhitemon/DeepMRG/embeddings_generated_using_prottrans/per_protein_embeddings_t5_xl_train_exp_plus_pred_clus_cd_hit40_from_all_mrg.h5"
    seq_path = "/home/muhitemon/DeepMRG/full_len_prot_train/train_exp_plus_pred_cd_hit40_from_all_mrg.fasta"
