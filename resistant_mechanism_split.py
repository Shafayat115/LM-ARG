    ...
    for line in lines:
        if line[0] == '>':
            ...
            while line[index]!='|':
                ...
                index+=1
            if (label in resistant_mechanisms):
                index =1
                label_id = ''
                while(line[index]!='|'):
...
for y in All_Labels:
    ...
    #randomtestlist = []
    with open('resistant_mechanism_1_train.fasta','a') as file1:
        with open('resistant_mechanism_1_test.fasta','a') as file2:
