...
def create_lablels_of_protein_seq(args):
    label = [0] * 5 # there are 23 types of metals in BacMet DB
    arg_list = args.split(',')
    for i in arg_list:
...
embedding_test_filename = "/home/shafayatpiyal/protAlbert/Results/Cross_Validate/Resistant_Mechanism_1_test_embedding.h5"
seq_test_path = "/home/shafayatpiyal/protAlbert/Resistant_Mechanism_1_test.fasta"
...
model = load_model('/home/shafayatpiyal/protAlbert/Results/Cross_Validate/Resistant_Mechanism_1_model.h5')
